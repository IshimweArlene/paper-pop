      ...
      <div className="w-183.5 h-full left-88.25 relative ">
        ...
        <section id="how-it-works">
          <div className="flex flex-col items-center justify-center mt-9.25">
            ...
            <div className="w-full h-43.5 mt-9.25 flex pt-4 px-39.5 items-start gap-14 border-[#DBD3D3] border-t">
            ...
            <div className="w-full h-43.5 flex pt-4 px-39.5 items-start gap-14 border-[#DBD3D3] border-t">
        ...
        <section id="features">
          ...
          <div className="w-183.5 flex flex-col items-center mt-3 px-26.75">
            ...
            <div className="grid grid-rows-2 gap-x-5 mt-3 ">
              <div className="grid grid-cols-2 gap-3 border-b border-[#DBD3D3] ml-3">
                <div className="flex flex-col items-start gap-2 border-r border-[#DBD3D3]">
